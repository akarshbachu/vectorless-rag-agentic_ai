...
*   **Python Environment:** Install required packages (`pip install pageindex openai groq ...`).
*   **API Keys:** Securely store `PAGEINDEX_API_KEY` and your chosen LLM API key (e.g., `GROQ_API_KEY`) in the `.env` file.
